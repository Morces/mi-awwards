...
class PostTest(TestCase):
    def setUp(self):
        ...
        self.post = Post.objects.create(id=1, title='test post', photo='https://ucarecdn.com/0ccf61ff-508e-46c6-b713-db51daa6626e', description='describe', user=self.user, url='http://linkedin/in/moseskarani')
